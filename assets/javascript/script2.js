	var topics = ["burger", "pizza", "sushi", "beer", "tequila", "lasagna", "steak", "bacon", "pasta", "eggs", "vodka", "pancakes", "tacos", "burritos", "nachos", "margarita", "wine", "wings", "coffee"];
	...
	$("#add-topic").on("click", function (event) {
        ...
        topic + "&api_key=9zTljuz52xTiM8TE1YDXRBBRb8b0p4dM&limit=10";
